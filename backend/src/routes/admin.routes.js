...
const { registerUser, adminResetPassword } = require('../controllers/auth.controller');
const { getUserPasswordAudit } = require('../controllers/passwordAudit.controller');
...
router.get('/users/:userId/password-audit', getUserPasswordAudit);
